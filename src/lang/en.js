export default {
  ...
  dashboard: {
    ...
    quotaTips: 'Unit: GB. Use -1 for unlimited. Editing one field updates the other automatically.',
    quota: 'Quota',
  ...
  config: {
    ...
    clashDirectDomains: 'Direct Sites (one per line)',
    clashProxyDomains: 'Proxy Sites (one per line)',
    clashDomainsTips: 'One domain per line, e.g. example.com; leave empty to follow the full rules above',
  ...
  valid: {
    ...
    clashDomainsRange: 'Custom sites range from 0-10000 characters',
