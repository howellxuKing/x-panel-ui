export default {
  ...
  config: {
    ...
    systemName: '系统名称',
    clashRule: 'Clash规则',
    clashDirectDomains: '直连网站（一行一个）',
    clashProxyDomains: '代理网站（一行一个）',
    clashDomainsTips: '一行一个域名，例：example.com；留空表示不额外添加，按上面的完整规则走',
    xrayTemplate: 'Xray模板',
    modifyPass: '修改密码',
    modifyProperty: '修改信息',
  },
  valid: {
    ...
    clashDomainsRange: '自定义网站的范围在0-10000字符之间',
