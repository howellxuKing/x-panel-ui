export default {
  ...
  dashboard: {
    ...
    residualFlow: 'جریان باقی‌مانده',
    quotaTips: 'واحد: گیگابایت؛ ‎-1 یعنی نامحدود؛ با تغییر هر فیلد دیگری خودکار محاسبه می‌شود',
    quota: 'جریان کل',
  ...
  config: {
    ...
    clashDirectDomains: 'سایت‌های مستقیم (هر خط یکی)',
    clashProxyDomains: 'سایت‌های پروکسی (هر خط یکی)',
    clashDomainsTips: 'در هر خط یک دامنه، مثال: example.com',
