export default {
  ...
  dashboard: {
    ...
    onLine: '온라인 사용자 수',
    residualFlow: '잔류 흐름',
    quotaTips: '단위: GB, -1은 무제한, 한쪽을 수정하면 다른 쪽이 자동 계산됩니다',
    quota: '총 흐름',
  ...
  config: {
    ...
    systemName: '시스템 이름',
    clashRule: 'Clash 규칙',
    clashDirectDomains: '직접 연결 사이트 (한 줄에 하나)',
    clashProxyDomains: '프록시 사이트 (한 줄에 하나)',
    clashDomainsTips: '한 줄에 도메인 하나, 예: example.com',
